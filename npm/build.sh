...
jfrog npm ci --project=${project} --build-name=${build_name} --build-number=${build_number}
jfrog npm publish --project=${project} --build-name=${build_name} --build-number=${build_number}
